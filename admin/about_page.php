<?php include('includes/header.php'); ?>
    ...
    <section id="main" class="column">		
        ...
        ?>
        <div class="clear"></div>
        <form name="add_intro_form" method="post" action="includes/add_about_process.php">
        <article class="module width_full">
            <header><h3>About Us</h3></header>
            <div class="module_content">
                <fieldset>
                    <label>Content</label>
                    <textarea rows="12" name="about_us"  class='textarea'>
                    <?php 
                        $q = mysql_query("SELECT * FROM about_us WHERE id = 1");
            ...
            <footer>
                <div class="submit_link">
                    <input type="submit" value="Add About Us Info" class="alt_btn">
