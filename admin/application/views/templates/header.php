...
<html>
  <head>
    ...
    <link href="<?php echo $base; ?>/assets/assets/styles.css" rel="stylesheet" media="screen">
     <!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
    <!--[if lt IE 9]>
      <script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
    <![endif]-->
    <script src="<?php echo $base; ?>assets/vendors/modernizr-2.6.2-respond-1.1.0.min.js"></script>
