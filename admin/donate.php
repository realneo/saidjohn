<?php include('includes/header.php'); ?>
    ...
    <section id="main" class="column">		
        ...
        ?>
        <div class="clear"></div>
        <form name="add_intro_form" method="post" action="includes/add_donate_process.php">
        <article class="module width_full">
            <header><h3>Donate</h3></header>
            <div class="module_content">
                <fieldset>
                    <label>Content</label>
                    <textarea rows="12" name="donate"  class='textarea'>
                    <?php 
                        $q = mysql_query("SELECT * FROM donate WHERE id = 1");
