...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="stylesheets/flexslider/flexslider.css" />
        <script type='text/javascript' src='javascript/jquery-1.9.1.js'></script>
        <script type='text/javascript' src='javascript/jquery.flexslider-min.js'></script>
        <script type='text/javascript' src='javascript/jqFancyTransitions.1.8.min.js'></script>
    ...
    <body>
        <div id="top_bar"> Heey </div><!-- top_bar -->
        <div id="container">
            <div id='bio_section'>
